namespace Noosium.Resources.Common.Private
{
    ...
    internal struct ElementNames
    {
        ...
        public const string MissionStartupLevelThreeQlEditorPickerLabel =
            "mission-startup-level-three-ql-editor-picker-label";
        public const string MissionStartupLevelThreeQlEditorPickerLabelTwo =
            "mission-startup-level-three-ql-editor-picker-label-tw";
        public const string MissionStartupLevelThreeQlEditorPickerLabelThr =
            "mission-startup-level-three-ql-editor-picker-label-th";
        public const string MissionStartupLevelThreeQlEditorItalic = "mission-startup-level-three-ql-editor-italic";
        public const string MissionStartupLevelThreeQlEditorH3= "mission-startup-level-three-ql-editor-h3";
        public const string MissionStartupLevelThreeQlEditorUnderline = "mission-startup-level-three-ql-editor-underline";
        public const string MissionStartupLevelThreeQlEditorListItemOne =
            "mission-startup-level-three-ql-editor-list-item-one";
        public const string MissionStartupLevelThreeQlEditorListItemTwo =
            "mission-startup-level-three-ql-editor-list-item-two";
        public const string MissionStartupLevelThreeQlEditorClean = "mission-startup-level-three-ql-editor-clean";
    }
}
